    ...
    content: (
      <div className="space-y-6">
        <p className="text-xl leading-relaxed">
          ...
          adapting to environmental changes. The Earth&apos;s climate is a complex
          network of interconnected systems, including atmospheric circulation,
          ocean currents, and land-atmosphere interactions.
        </p>
    ...
    content: (
      <div className="space-y-6">
        <p className="text-xl leading-relaxed">
          ...
          It&apos;s about creating positive social impact while maintaining ethical
          business practices.
        </p>
